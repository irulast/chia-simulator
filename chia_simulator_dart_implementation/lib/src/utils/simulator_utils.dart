...
import 'package:chia_simulator_dart_implementation/src/exceptions/simulator_auth_files_not_found.dart';
...
class SimulatorUtils {
  ...
  static String get homePath => String.fromEnvironment('HOME');
  static String get defaultgeneratedFilesPath => path.join(homePath, '/.chia-simulator');
